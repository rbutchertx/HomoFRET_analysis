function [] = analyze_NarXL_longTC_SuppPromoters(rr_conc)
...
samp1 = [rr_conc(1,1:5,1); rr_conc(1,1:5,2); rr_conc(1,1:5,3)]/100000; 
samp2 = [rr_conc(1,6:10,1); rr_conc(1,6:10,2); rr_conc(1,6:10,3)]/100000;

T50_f1 = [T50_f(1:5); T50_f(11:15); T50_f(21:25)];
T50_f2 = [T50_f(6:10); T50_f(16:20); T50_f(26:30)];

figure('Name','S9D','IntegerHandle','off','Units', 'inches', 'Position', [0 0 8 4.725]); hold on;
scatter(mean(samp1,1),mean(T50_f1,1), ...
    40,'o','MarkerEdgeColor','k','MarkerFaceColor',1*c,'LineWidth',1);
scatter(mean(samp2,1),mean(T50_f2,1), ...
    40,'s','MarkerEdgeColor','k','MarkerFaceColor',1*c,'LineWidth',1);
...
errorbar(mean(samp1,1),mean(T50_f1,1),std(T50_f1,[],1),std(T50_f1,[],1), ...
    'o','MarkerEdgeColor','k','MarkerFaceColor',1*c,'LineWidth',1,'Color','k','LineStyle','-');
errorbar(mean(samp2,1),mean(T50_f2,1),std(T50_f2,[],1),std(T50_f2,[],1), ...
    's','MarkerEdgeColor','k','MarkerFaceColor',1*c,'LineWidth',1,'Color','k','LineStyle','-');
