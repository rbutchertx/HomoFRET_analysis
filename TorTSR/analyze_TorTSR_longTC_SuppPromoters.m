function [] = analyze_TorTSR_longTC_SuppPromoters(rr_conc)
...
figure('Name','S4D','IntegerHandle','off','Units', 'inches', 'Position', [0 0 8 4.725]); hold on;
...
scatter(mean(samp2,1),mean(T50_f2,1), ...
    ...
    legend('-P{\it_t_o_r_C_A_D}_1_2_9', ...
        '+P{\it_t_o_r_C_A_D}_1_2_9', ...
