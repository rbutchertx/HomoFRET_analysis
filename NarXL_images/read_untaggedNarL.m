...
for i = 1:3
    for j = 1:3
        nl_ims{i}(:,:,j) = double(imread(['UntaggedNarL/' strain '_off_1_00' num2str(i) '.tif'],'Index',j));
        nl_ims{i+3}(:,:,j) = double(imread(['UntaggedNarL/' strain '_off_2_00' num2str(i) '.tif'],'Index',j));
        yl_ims{i}(:,:,j) = double(imread(['UntaggedNarL/' strain '_on_1_00' num2str(i) '.tif'],'Index',j));
        yl_ims{i+3}(:,:,j) = double(imread(['UntaggedNarL/' strain '_on_2_00' num2str(i) '.tif'],'Index',j));
    end
end
